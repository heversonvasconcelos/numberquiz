...
public final class ProblemDAOTest {
    ...
    public void create() {
        ...
        if (!problemDao.verifyIfProblemSequenceExists(problem00.getIntegerArrayProblemSequence())) {
        ...
        if (!problemDao.verifyIfProblemSequenceExists(problem01.getIntegerArrayProblemSequence())) {
        ...
        if (!problemDao.verifyIfProblemSequenceExists(problem02.getIntegerArrayProblemSequence())) {
        ...
        if (!problemDao.verifyIfProblemSequenceExists(problem03.getIntegerArrayProblemSequence())) {
        ...
        if (!problemDao.verifyIfProblemSequenceExists(problem04.getIntegerArrayProblemSequence())) {
    ...
    public void listAProblem() {
        ...
        Problem problemFound = (problemToFind != null)
                ? problemDao.getProblemBySequence(problemToFind.getIntegerArrayProblemSequence()) : null;
