 ...
 * 
 * Interface que descreve a assinatura da operações básicas que cada entidade do
 * banco irá realizar. Operações do CRUD e mais uma de listagem.
 * 
...
public interface GenericDao<T, ID extends Serializable> {
	 ...
	 * 
	 * @param obj
	 *            Objeto a ser inserido no banco.
	 */
